...
<html <?php language_attributes(); ?>>
    ...
    <body <?php body_class(); ?>>
        ...
        .topNavPush {margin-top: 10px}
        .mainNavPush {margin-top: 0px;margin-left: -20px;}
        ...
        <div id="wrapper" class="hfeed">
            <header id="header" role="banner" class="max-width-1100">
                ...
                <nav id="menu" role="navigation" class="topNavPush" >
      <nav class="category-container grid-10 tablet-grid-100 mobile-grid-100 ">
                <section id="branding">
                    <div id="site-title">
                    ...
                    <nav class="category-container grid-50 tablet-grid-100 mobile-grid-100 hide-on-mobile mainNavPush" >
