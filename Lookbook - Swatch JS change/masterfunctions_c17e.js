...
function(e) {
    e.widget("ui.draggable", e.ui.mouse, {
        ...
        drag: function(t, i) {
            var s, n, a, o, r, l, c, d, h, u, p = e(this).data("ui-draggable"),
                f = p.options,
                g = f.snapTolerance,
                m = i.offset.left,
            ...
            for (h = p.snapElements.length - 1; h >= 0; h--) r = p.snapElements[h].left, l = r + p.snapElements[h].width, c = p.snapElements[h].top, d = c + p.snapElements[h].height, r - g > v || m > l + g || c - g > y || b > d + g || !e.contains(p.snapElements[h].item.ownerDocument, p.snapElements[h].item) ? (p.snapElements[h].snapping && p.options.snap.release && p.options.snap.release.call(p.element, t, e.extend(p._uiHash(), {
                snapItem: p.snapElements[h].item
            })), p.snapElements[h].snapping = !1) : ("inner" !== f.snapMode && (s = g >= Math.abs(c - y), n = g >= Math.abs(d - b), a = g >= Math.abs(r - v), o = g >= Math.abs(l - m), s && (i.position.top = p._convertPositionTo("relative", {
                ...
                top: 0,
                left: l
            }).left - p.margins.left)), u = s || n || a || o, "outer" !== f.snapMode && (s = g >= Math.abs(c - b), n = g >= Math.abs(d - y), a = g >= Math.abs(r - m), o = g >= Math.abs(l - v), s && (i.position.top = p._convertPositionTo("relative", {
                top: c,
                left: 0
            }).top - p.margins.top), n && (i.position.top = p._convertPositionTo("relative", {
            ...
            }).left - p.margins.left)), !p.snapElements[h].snapping && (s || n || a || o || u) && p.options.snap.snap && p.options.snap.snap.call(p.element, t, e.extend(p._uiHash(), {
                snapItem: p.snapElements[h].item
            })), p.snapElements[h].snapping = s || n || a || o || u)
        }
...
function(e) {
    ...
    e.widget("ui.droppable", {
        ...
        switch (s) {
            case "fit":
                return o >= d && h >= r && l >= u && p >= c;
            case "intersect":
                return o + e.helperProportions.width / 2 > d && h > r - e.helperProportions.width / 2 && l + e.helperProportions.height / 2 > u && p > c - e.helperProportions.height / 2;
            case "pointer":
                return n = (e.positionAbs || e.position.absolute).left + (e.clickOffset || e.offset.click).left, a = (e.positionAbs || e.position.absolute).top + (e.clickOffset || e.offset.click).top, t(a, u, i.proportions.height) && t(n, d, i.proportions.width);
            case "touch":
                return (l >= u && p >= l || c >= u && p >= c || u > l && c > p) && (o >= d && h >= o || r >= d && h >= r || d > o && r > h);
            default:
                return !1
        }
    }, e.ui.ddmanager = {
    ...
    e.widget("ui.resizable", e.ui.mouse, {
        ...
        _respectSize: function(e) {
            var t = this._vBoundaries,
                ...
                d = /sw|nw|w/.test(s),
                h = /nw|ne|n/.test(s);
            return o && (e.width = t.minWidth), r && (e.height = t.minHeight), n && (e.width = t.maxWidth), a && (e.height = t.maxHeight), o && d && (e.left = l - t.minWidth), n && d && (e.left = l - t.maxWidth), r && h && (e.top = c - t.minHeight), a && h && (e.top = c - t.maxHeight), e.width || e.height || e.left || !e.top ? e.width || e.height || e.top || !e.left || (e.left = null) : e.top = null, e
        },
        ...
        resize: function() {
            ...
            i.grid = r, m && (u += l), v && (p += c), f && (u -= l), g && (p -= c), /^(se|s|e)$/.test(o) ? (t.size.width = u, t.size.height = p) : /^(ne)$/.test(o) ? (t.size.width = u, t.size.height = p, t.position.top = a.top - h) : /^(sw)$/.test(o) ? (t.size.width = u, t.size.height = p, t.position.left = a.left - d) : (t.size.width = u, t.size.height = p, t.position.top = a.top - h, t.position.left = a.left - d)
        }
    })
}(jQuery),
function(e) {
    ...
    e.widget("ui.sortable", e.ui.mouse, {
        ...
        _intersectsWith: function(e) {
            var t = this.positionAbs.left,
                ...
                h = "x" === this.options.axis || s + c > r && l > s + c,
                u = "y" === this.options.axis || t + d > a && o > t + d,
                p = h && u;
        ...
        _refreshItems: function(t) {
            ...
            if (u && this.ready)
                for (i = u.length - 1; i >= 0; i--)
                    for (n = e(u[i]), s = n.length - 1; s >= 0; s--) a = e.data(n[s], this.widgetFullName), a && a !== this && !a.options.disabled && (h.push([e.isFunction(a.options.items) ? a.options.items.call(a.element[0], t, {
                        item: this.currentItem
                    }) : e(a.options.items, a.element), a]), this.containers.push(a));
            for (i = h.length - 1; i >= 0; i--)
                for (o = h[i][1], r = h[i][0], s = 0, c = r.length; c > s; s++) l = e(r[s]), l.data(this.widgetName + "-item", o), d.push({
                    item: l,
                    instance: o,
                    width: 0,
                    height: 0,
        ...
        _contactContainers: function(s) {
            var n, a, o, r, l, c, d, h, u, p, f = null,
                g = null;
            ...
            if (f)
                if (1 === this.containers.length) this.containers[g].containerCache.over || (this.containers[g]._trigger("over", s, this._uiHash(this)), this.containers[g].containerCache.over = 1);
                    ...
                    for (o = 1e4, r = null, p = f.floating || i(this.currentItem), l = p ? "left" : "top", c = p ? "width" : "height", d = this.positionAbs[l] + this.offset.click[l], a = this.items.length - 1; a >= 0; a--) e.contains(this.containers[g].element[0], this.items[a].item[0]) && this.items[a].item[0] !== this.currentItem[0] && (!p || t(this.positionAbs.top + this.offset.click.top, this.items[a].top, this.items[a].height)) && (h = this.items[a].item.offset()[l], u = !1, Math.abs(h - d) > Math.abs(h + this.items[a][c] - d) && (u = !0, h += this.items[a][c]), o > Math.abs(h - d) && (o = Math.abs(h - d), r = this.items[a], this.direction = u ? "up" : "down"));
            ...
            p.style.cssText = "background-color:rgba(1,1,1,.5)", u.rgba = p.style.backgroundColor.indexOf("rgba") > -1, f(d, function(e, t) {
                ...
                parse: function(n, o, r, l) {
                    ...
                    var h = this,
                        u = e.type(n),
                        p = this._rgba = [];
                    return o !== t && (n = [n, o, r, l], u = "array"), "string" === u ? this.parse(s(n) || a._default) : "array" === u ? (f(d.rgba.props, function(e, t) {
                        p[t.idx] = i(n[t.idx], t)
                    }), this) : "object" === u ? (n instanceof c ? f(d, function(e, t) {
                        n[t.cache] && (h[t.cache] = n[t.cache].slice())
                    }) : f(d, function(t, s) {
                        var a = s.cache;
                        f(s.props, function(e, t) {
                            ...
                            h[a][t.idx] = i(n[e], t, !0)
                        }), h[a] && 0 > e.inArray(null, h[a].slice(0, 3)) && (h[a][3] = 1, s.from && (h._rgba = s.from(h[a])))
                    }), this) : t
                },
                is: function(e) {
                    var i = c(e),
                ...
                var t, i, s = e[0] / 255,
                    ...
                    d = r + l,
                    h = .5 * d;
                return t = l === r ? 0 : s === r ? 60 * (n - a) / c + 360 : n === r ? 60 * (a - s) / c + 120 : 60 * (s - n) / c + 240, i = 0 === c ? 0 : .5 >= h ? c / d : c / (2 - d), [Math.round(t) % 360, i, h, null == o ? 1 : o]
                ...
                c.fn[s] = function(s) {
                    ...
                    var n, r = e.type(s),
                        h = "array" === r || "object" === r ? s : arguments,
                        u = this[o].slice();
                    return f(a, function(e, t) {
                        var s = h["object" === r ? e : t.idx];
                        null == s && (s = u[t.idx]), u[t.idx] = i(s, t)
                    }), d ? (n = c(d(u)), n[o] = u, n) : c(u)
                }, f(a, function(t, i) {
...
function(e) {
    ...
    i.height = i.paddingTop = i.paddingBottom = i.borderTopWidth = i.borderBottomWidth = "hide", s.height = s.paddingTop = s.paddingBottom = s.borderTopWidth = s.borderBottomWidth = "show", e.widget("ui.accordion", {
        ...
        _animate: function(e, t, n) {
            ...
            return "number" == typeof u && (r = u), "string" == typeof u && (o = u), o = o || u.easing || h.easing, r = r || u.duration || h.duration, t.length ? e.length ? (a = e.show().outerHeight(), t.animate(i, {
                duration: r,
                easing: o,
                step: function(e, t) {
                    t.now = Math.round(e)
    ...
    e.widget("ui.button", {
        ...
        _create: function() {
            ...
            null === r.label && (r.label = "input" === this.type ? this.buttonElement.val() : this.buttonElement.html()), this._hoverable(this.buttonElement), this.buttonElement.addClass(a).attr("role", "button").bind("mouseenter" + this.eventNamespace, function() {
                ...
                o.buttonElement.addClass(u)
            }).bind("blur" + this.eventNamespace, function() {
                o.buttonElement.removeClass(u)
...
function(e, t) {
    ...
    e.extend(i.prototype, {
        ...
        formatDate: function(e, t, i) {
            ...
            if (t)
                for (s = 0; e.length > s; s++)
                    if (u) "'" !== e.charAt(s) || l("'") ? h += e.charAt(s) : u = !1;
        ...
        _generateHTML: function(e) {
            var t, i, s, n, a, o, r, l, c, d, h, u, p, f, g, m, v, b, y, w, N, k, x, _, C, S, $, T, P, j, z, A, D, I, R, M, E, W, O, H = new Date,
            ...
            for (e.drawMonth = Z, e.drawYear = et, i = this._get(e, "prevText"), i = F ? this.formatDate(i, this._daylightSavingAdjust(new Date(et, Z - V, 1)), this._getFormatConfig(e)) : i, s = this._canAdjustMonth(e, -1, et, Z) ? "<a class='ui-datepicker-prev ui-corner-all' data-handler='prev' data-event='click' title='" + i + "'><span class='ui-icon ui-icon-circle-triangle-" + (L ? "e" : "w") + "'>" + i + "</span></a>" : Q ? "" : "<a class='ui-datepicker-prev ui-corner-all ui-state-disabled' title='" + i + "'><span class='ui-icon ui-icon-circle-triangle-" + (L ? "e" : "w") + "'>" + i + "</span></a>", n = this._get(e, "nextText"), n = F ? this.formatDate(n, this._daylightSavingAdjust(new Date(et, Z + V, 1)), this._getFormatConfig(e)) : n, a = this._canAdjustMonth(e, 1, et, Z) ? "<a class='ui-datepicker-next ui-corner-all' data-handler='next' data-event='click' title='" + n + "'><span class='ui-icon ui-icon-circle-triangle-" + (L ? "w" : "e") + "'>" + n + "</span></a>" : Q ? "" : "<a class='ui-datepicker-next ui-corner-all ui-state-disabled' title='" + n + "'><span class='ui-icon ui-icon-circle-triangle-" + (L ? "w" : "e") + "'>" + n + "</span></a>", o = this._get(e, "currentText"), r = this._get(e, "gotoCurrent") && e.currentDay ? J : q, o = F ? this.formatDate(o, r, this._getFormatConfig(e)) : o, l = e.inline ? "" : "<button type='button' class='ui-datepicker-close ui-state-default ui-priority-primary ui-corner-all' data-handler='hide' data-event='click'>" + this._get(e, "closeText") + "</button>", c = B ? "<div class='ui-datepicker-buttonpane ui-widget-content'>" + (L ? l : "") + (this._isInRange(e, r) ? "<button type='button' class='ui-datepicker-current ui-state-default ui-priority-secondary ui-corner-all' data-handler='today' data-event='click'>" + o + "</button>" : "") + (L ? "" : l) + "</div>" : "", d = parseInt(this._get(e, "firstDay"), 10), d = isNaN(d) ? 0 : d, h = this._get(e, "showWeek"), u = this._get(e, "dayNames"), p = this._get(e, "dayNamesMin"), f = this._get(e, "monthNames"), g = this._get(e, "monthNamesShort"), m = this._get(e, "beforeShowDay"), v = this._get(e, "showOtherMonths"), b = this._get(e, "selectOtherMonths"), y = this._getDefaultDate(e), w = "", k = 0; U[0] > k; k++) {
                for (x = "", this.maxRows = 4, _ = 0; U[1] > _; _++) {
                    ...
                    for ($ += "<div class='ui-datepicker-header ui-widget-header ui-helper-clearfix" + S + "'>" + (/all|left/.test(S) && 0 === k ? L ? a : s : "") + (/all|right/.test(S) && 0 === k ? L ? s : a : "") + this._generateMonthYearHeader(e, Z, et, G, K, k > 0 || _ > 0, f, g) + "</div><table class='ui-datepicker-calendar'><thead><tr>", T = h ? "<th class='ui-datepicker-week-col'>" + this._get(e, "weekHeader") + "</th>" : "", N = 0; 7 > N; N++) P = (N + d) % 7, T += "<th" + ((N + d + 6) % 7 >= 5 ? " class='ui-datepicker-week-end'" : "") + "><span title='" + u[P] + "'>" + p[P] + "</span></th>";
                    for ($ += T + "</tr></thead><tbody>", j = this._getDaysInMonth(et, Z), et === e.selectedYear && Z === e.selectedMonth && (e.selectedDay = Math.min(e.selectedDay, j)), z = (this._getFirstDayOfMonth(et, Z) - d + 7) % 7, A = Math.ceil((z + j) / 7), D = X && this.maxRows > A ? this.maxRows : A, this.maxRows = D, I = this._daylightSavingAdjust(new Date(et, Z, 1 - z)), R = 0; D > R; R++) {
                        for ($ += "<tr>", M = h ? "<td class='ui-datepicker-week-col'>" + this._get(e, "calculateWeek")(I) + "</td>" : "", N = 0; 7 > N; N++) E = m ? m.apply(e.input ? e.input[0] : null, [I]) : [!0, ""], W = I.getMonth() !== Z, O = W && !b || !E[0] || G && G > I || K && I > K, M += "<td class='" + ((N + d + 6) % 7 >= 5 ? " ui-datepicker-week-end" : "") + (W ? " ui-datepicker-other-month" : "") + (I.getTime() === C.getTime() && Z === e.selectedMonth && e._keyEvent || y.getTime() === I.getTime() && y.getTime() === C.getTime() ? " " + this._dayOverClass : "") + (O ? " " + this._unselectableClass + " ui-state-disabled" : "") + (W && !v ? "" : " " + E[1] + (I.getTime() === J.getTime() ? " " + this._currentClass : "") + (I.getTime() === q.getTime() ? " ui-datepicker-today" : "")) + "'" + (W && !v || !E[2] ? "" : " title='" + E[2].replace(/'/g, "&#39;") + "'") + (O ? "" : " data-handler='selectDay' data-event='click' data-month='" + I.getMonth() + "' data-year='" + I.getFullYear() + "'") + ">" + (W && !v ? "&#xa0;" : O ? "<span class='ui-state-default'>" + I.getDate() + "</span>" : "<a class='ui-state-default" + (I.getTime() === q.getTime() ? " ui-state-highlight" : "") + (I.getTime() === J.getTime() ? " ui-state-active" : "") + (W ? " ui-priority-secondary" : "") + "' href='#'>" + I.getDate() + "</a>") + "</td>", I.setDate(I.getDate() + 1), I = this._daylightSavingAdjust(I);
                        $ += M + "</tr>"
                    }
                    Z++, Z > 11 && (Z = 0, et++), $ += "</tbody></table>" + (X ? "</div>" + (U[0] > 0 && _ === U[1] - 1 ? "<div class='ui-datepicker-row-break'></div>" : "") : ""), x += $
                }
                w += x
            }
        ...
        _generateMonthYearHeader: function(e, t, i, s, n, a, o, r) {
            var l, c, d, h, u, p, f, g, m = this._get(e, "changeMonth"),
            ...
            if (b || (y += w + (!a && m && v ? "" : "&#xa0;")), !e.yearshtml)
                if (e.yearshtml = "", a || !v) y += "<span class='ui-datepicker-year'>" + i + "</span>";
                    ...
                    for (h = this._get(e, "yearRange").split(":"), u = (new Date).getFullYear(), p = function(e) {
                            ...
                            return isNaN(t) ? u : t
                        }, f = p(h[0]), g = Math.max(f, p(h[1] || "")), f = s ? Math.max(f, s.getFullYear()) : f, g = n ? Math.min(g, n.getFullYear()) : g, e.yearshtml += "<select class='ui-datepicker-year' data-handler='selectYear' data-event='change'>"; g >= f; f++) e.yearshtml += "<option value='" + f + "'" + (f === i ? " selected='selected'" : "") + ">" + f + "</option>";
...
function(e) {
    e.effects.effect.bounce = function(t, i) {
        ...
        for ((d || c) && r.push("opacity"), e.effects.save(o, r), o.show(), e.effects.createWrapper(o), u || (u = o["top" === v ? "outerHeight" : "outerWidth"]() / 3), d && (a = {
                opacity: 1
            }, a[v] = 0, o.css("opacity", 0).css(v, b ? 2 * -u : 2 * u).animate(a, g, m)), c && (u /= Math.pow(2, p - 1)), a = {}, a[v] = 0, s = 0; p > s; s++) n = {}, n[v] = (b ? "-=" : "+=") + u, o.animate(n, g, m).animate(a, g, m), u = c ? 2 * u : u / 2;
        c && (n = {
            opacity: 0
        }, n[v] = (b ? "-=" : "+=") + u, o.animate(n, g, m)), o.queue(function() {
...
function(e) {
    e.effects.effect.clip = function(t, i) {
        ...
        e.effects.save(o, r), o.show(), s = e.effects.createWrapper(o).css({
            overflow: "hidden"
        }), n = "IMG" === o[0].tagName ? s : o, a = n[u](), c && (n.css(u, 0), n.css(p, a / 2)), f[u] = c ? a : 0, f[p] = c ? 0 : a / 2, n.animate(f, {
            queue: !1,
            duration: t.duration,
            easing: t.easing,
            complete: function() {
...
function(e) {
    e.effects.effect.drop = function(t, i) {
        ...
        e.effects.save(n, a), n.show(), e.effects.createWrapper(n), s = t.distance || n["top" === c ? "outerHeight" : "outerWidth"](!0) / 2, r && n.css("opacity", 0).css(c, "pos" === d ? -s : s), h[c] = (r ? "pos" === d ? "+=" : "-=" : "pos" === d ? "-=" : "+=") + s, n.animate(h, {
            queue: !1,
            duration: t.duration,
            easing: t.easing,
            complete: function() {
...
function(e) {
    e.effects.effect.explode = function(t, i) {
        ...
        var a, o, r, l, c, d, h = t.pieces ? Math.round(Math.sqrt(t.pieces)) : 3,
            ...
            y = [];
        for (a = 0; h > a; a++)
            for (l = m.top + a * b, d = a - (h - 1) / 2, o = 0; u > o; o++) r = m.left + o * v, c = o - (u - 1) / 2, p.clone().appendTo("body").wrap("<div></div>").css({
                position: "absolute",
                visibility: "visible",
                left: -o * v,
                top: -a * b
...
function(e) {
    e.effects.effect.fold = function(t, i) {
        ...
        e.effects.save(a, o), a.show(), s = e.effects.createWrapper(a).css({
            overflow: "hidden"
        }), n = p ? [s.width(), s.height()] : [s.height(), s.width()], h && (d = parseInt(h[1], 10) / 100 * n[c ? 0 : 1]), l && s.css(u ? {
            height: 0,
            width: d
        } : {
            height: d,
...
function(e) {
    e.effects.effect.pulsate = function(t, i) {
        var s, n = e(this),
            ...
            u = n.queue(),
            p = u.length;
        for ((o || !n.is(":visible")) && (n.css("opacity", 0).show(), h = 1), s = 1; c > s; s++) n.animate({
            opacity: h
        }, d, t.easing), h = 1 - h;
        n.animate({
            opacity: h
...
function(e) {
    e.effects.effect.puff = function(t, i) {
        ...
        "show" === p && o.show(), s = {
        ...
        }, ("box" === g || "both" === g) && (a.from.y !== a.to.y && (b = b.concat(h), o.from = e.effects.setTransition(o, h, a.from.y, o.from), o.to = e.effects.setTransition(o, h, a.to.y, o.to)), a.from.x !== a.to.x && (b = b.concat(u), o.from = e.effects.setTransition(o, u, a.from.x, o.from), o.to = e.effects.setTransition(o, u, a.to.x, o.to))), ("content" === g || "both" === g) && a.from.y !== a.to.y && (b = b.concat(d).concat(c), o.from = e.effects.setTransition(o, d, a.from.y, o.from), o.to = e.effects.setTransition(o, d, a.to.y, o.to)), e.effects.save(o, b), o.show(), e.effects.createWrapper(o), o.css("overflow", "hidden").css(o.from), m && (n = e.effects.getBaseline(m, s), o.from.top = (s.outerHeight - o.outerHeight()) * n.y, o.from.left = (s.outerWidth - o.outerWidth()) * n.x, o.to.top = (s.outerHeight - o.to.outerHeight) * n.y, o.to.left = (s.outerWidth - o.to.outerWidth) * n.x), o.css(o.from), ("content" === g || "both" === g) && (h = h.concat(["marginTop", "marginBottom"]).concat(d), u = u.concat(["marginLeft", "marginRight"]), c = r.concat(h).concat(u), o.find("*[width]").each(function() {
            var i = e(this),
                s = {
                    height: i.height(),
                    width: i.width(),
            ...
            }, a.from.y !== a.to.y && (i.from = e.effects.setTransition(i, h, a.from.y, i.from), i.to = e.effects.setTransition(i, h, a.to.y, i.to)), a.from.x !== a.to.x && (i.from = e.effects.setTransition(i, u, a.from.x, i.from), i.to = e.effects.setTransition(i, u, a.to.x, i.to)), i.css(i.from), i.animate(i.to, t.duration, t.easing, function() {
...
function(e) {
    e.effects.effect.shake = function(t, i) {
        var s, n = e(this),
            ...
            v = n.queue(),
            b = v.length;
        for (e.effects.save(n, a), n.show(), e.effects.createWrapper(n), f[u] = (p ? "-=" : "+=") + l, g[u] = (p ? "+=" : "-=") + 2 * l, m[u] = (p ? "-=" : "+=") + 2 * l, n.animate(f, h, t.easing), s = 1; c > s; s++) n.animate(g, h, t.easing).animate(m, h, t.easing);
        n.animate(g, h, t.easing).animate(f, h / 2, t.easing).queue(function() {
            "hide" === o && n.hide(), e.effects.restore(n, a), e.effects.removeWrapper(n), i()
...
function(e) {
    e.effects.effect.slide = function(t, i) {
        ...
        e.effects.save(n, a), n.show(), s = t.distance || n["top" === c ? "outerHeight" : "outerWidth"](!0), e.effects.createWrapper(n).css({
            overflow: "hidden"
        }), r && n.css(c, d ? isNaN(s) ? "-" + s : -s : s), h[c] = (r ? d ? "+=" : "-=" : d ? "-=" : "+=") + s, n.animate(h, {
            queue: !1,
            duration: t.duration,
            easing: t.easing,
            complete: function() {
...
function(e, t) {
    ...
    e.position = {
            ...
            return b = n(y), y[0].preventDefault && (t.at = "left top"), p = b.width, g = b.height, m = b.offset, v = e.extend({}, m), e.each(["my", "at"], function() {
                ...
                1 === s.length && (s = c.test(s[0]) ? s.concat(["center"]) : d.test(s[0]) ? ["center"].concat(s) : ["center", "center"]), s[0] = c.test(s[0]) ? s[0] : "center", s[1] = d.test(s[1]) ? s[1] : "center", e = h.exec(s[0]), i = h.exec(s[1]), x[this] = [e ? e[0] : 0, i ? i[0] : 0], t[this] = [u.exec(s[0])[0], u.exec(s[1])[0]]
                ...
                var n, c, d = e(this),
                    ...
                    f = s(this, "marginLeft"),
                    b = s(this, "marginTop"),
                    _ = h + f + s(this, "marginRight") + N.width,
                    C = u + b + s(this, "marginBottom") + N.height,
                    S = e.extend({}, v),
                    $ = i(x.my, d.outerWidth(), d.outerHeight());
                "right" === t.my[0] ? S.left -= h : "center" === t.my[0] && (S.left -= h / 2), "bottom" === t.my[1] ? S.top -= u : "center" === t.my[1] && (S.top -= u / 2), S.left += $[0], S.top += $[1], e.support.offsetFractions || (S.left = l(S.left), S.top = l(S.top)), n = {
                    marginLeft: f,
                    marginTop: b
                    ...
                    h > p && p > r(i + s) && (l.horizontal = "center"), u > g && g > r(n + a) && (l.vertical = "middle"), l.important = o(r(i), r(s)) > o(r(n), r(a)) ? "horizontal" : "vertical", t.using.call(this, e, l)
                }), d.offset(e.extend(S, {
                    using: c
                }))
            })
            ...
            flip: {
                left: function(e, t) {
                    var i, s, n = t.within,
                        ...
                        f = -2 * t.offset[0];
                    0 > d ? (i = e.left + u + p + f + t.collisionWidth - o - a, (0 > i || r(d) > i) && (e.left += u + p + f)) : h > 0 && (s = e.left - t.collisionPosition.marginLeft + u + p + f - l, (s > 0 || h > r(s)) && (e.left += u + p + f))
                },
                top: function(e, t) {
                    var i, s, n = t.within,
                        ...
                        g = -2 * t.offset[1];
                    0 > d ? (s = e.top + p + f + g + t.collisionHeight - o - a, e.top + p + f + g > d && (0 > s || r(d) > s) && (e.top += p + f + g)) : h > 0 && (i = e.top - t.collisionPosition.marginTop + p + f + g - l, e.top + p + f + g > h && (i > 0 || h > r(i)) && (e.top += p + f + g))
                }
            },
            flipfit: {
                left: function() {
    ...
    e.widget("ui.slider", e.ui.mouse, {
        ...
        _mouseCapture: function(t) {
            ...
            return h.disabled ? !1 : (this.elementSize = {
                ...
                (n > i || n === i && (t === d._lastChangedValue || d.values(t) === h.min)) && (n = i, a = e(this), o = t)
...
function(e) {
    ...
    function(e) {
        e.widget("accordiona.accordionA", {
            ...
            _create: function() {
                this.$window = e(window), this.$document = e(document), this.sections = this.element.find(this.options.section), this.html = e("html").addClass("js"), this.element.attr("role", "tablist").delegate(this.sections.prop("nodeName") + " " + this.options.header, "click focus blur".split(" ").concat("").join("." + this.namespace + " "), e.proxy(function(t) {
                    ...
                    switch (i.find(this.options.content), t.type) {
                        case "click":
        ...
        window.flowplayer = function(t) {
            return e.isFunction(t) ? h.push(t) : "number" == typeof t || void 0 === t ? d[t || 0] : e(t).data("flowplayer")
        ...
        e.fn.flowplayer = function(t, i) {
            return "string" == typeof t && (t = {
                ...
                var y = m || {
                    conf: o,
                    currentSpeed: 1,
                    volumeLevel: "undefined" == typeof o.volume ? 1 * u.volume : o.volume,
                    video: {},
                    disabled: !1,
                    finished: !1,
                    loading: !1,
                    muted: "true" == u.muted || o.muted,
                    paused: !1,
                    playing: !1,
                    ready: !1,
                    splash: !1,
                    ...
                    mute: function(e) {
                        return void 0 === e && (e = !y.muted), u.muted = y.muted = e, u.volume = isNaN(u.volume) ? o.volume : u.volume, y.volume(e ? 0 : u.volume, !0), y.trigger("mute", e), y
                    },
                    volume: function(e, t) {
                        return y.ready && (e = Math.min(Math.max(e, 0), 1), t || (u.volume = e), n.volume(e)), y
                    },
                    speed: function(t, i) {
                ...
                y.conf = e.extend(y.conf, o), e.each(["bind", "one", "unbind"], function(e, t) {
                    ...
                    return e.each(["autoplay", "loop", "preload", "poster"], function(e, t) {
                        var i = l.attr(t);
                        void 0 !== i && (o[t] = i ? i : !0)
                    }), (o.splash || a.hasClass("is-splash") || !flowplayer.support.firstframe) && (y.forcedSplash = !o.splash && !a.hasClass("is-splash"), y.splash = o.splash = o.autoplay = !0, a.addClass("is-splash"), flowplayer.support.video && l.attr("preload", "none")), (o.live || a.hasClass("is-live")) && (y.live = o.live = !0, a.addClass("is-live")), e.each(h, function() {
                        this(y, a)
                    ...
                    t.volumeLevel = Math.round(100 * i) / 100, t.muted ? i && t.mute(!1) : u.volume = i
            ...
            var t = function(e) {
                ...
                h = /Android/.test(o) && /Firefox/.test(o),
                u = /Silk/.test(o),
                p = /IEMobile/.test(o),
            ...
            var n, a, o, r = i.conf,
                l = (i.video, {
                    ...
                    load: function(l) {
                        ...
                        if (flowplayer.support.video && d.prop("autoplay") && f(l.sources) ? d.one("timeupdate", p) : p(), is_absolute || r.rtmp || (h = e("<img/>").attr("src", h)[0].src), o) o.__play(h);
                        else {
            ...
            return i.bind("ready fullscreen fullscreen-exit", function(t) {
                ...
                if (i.conf.flashfit || /full/.test(t.type)) {
                    var o, r, l = i.isFullscreen,
                        d = l && T,
                        h = !flowplayer.support.inlineBlock,
                        u = l ? d ? screen.width : c.width() : a,
                        p = l ? d ? screen.height : c.height() : n,
                        f = 0,
                        g = 0,
                        m = h ? a : "",
                        v = h ? n : "";
                    (i.conf.flashfit || "fullscreen" === t.type) && (o = i.video.width / i.video.height, r = i.video.height / i.video.width, v = Math.max(r * u), m = Math.max(o * p), v = v > p ? m * r : v, v = Math.min(Math.round(v), p), m = m > u ? v * o : m, m = Math.min(Math.round(m), u), g = Math.max(Math.round((p + g - v) / 2), 0), f = Math.max(Math.round((u + f - m) / 2), 0)), e("object", s).css({
                        width: m,
                        height: v,
                        marginTop: g,
                        marginLeft: f
        ...
        flowplayer.engine.html5 = function(t, s) {
                            ...
                            switch (o) {
                                case "ready":
                                    ...
                                    if (l = l || setInterval(function() {
                                        ...
                                        }, 250), !p.live && !d.duration && !h.hlsDuration && "loadeddata" === n) {
                                        var g = function() {
                                            d.duration = a.duration;
                                            try {
                                                d.seekable = a.seekable && a.seekable.end(null)
                                            } catch (e) {}
                                            t.trigger(u, d), a.removeEventListener("durationchange", g)
                                        };
                                ...
                                case "progress":
                                case "seek":
                                    if (t.video.duration, a.currentTime > 0) {
            ...
            return r = {
                ...
                load: function(i) {
                    if (p.splash && !c) d = y(i).prependTo(s), h.inlineVideo || d.css({
                        position: "absolute",
                        top: "-9999em"
                    }), u.length && d.append(u.attr("default", "")), p.loop && d.attr("loop", "loop"), c = d[0];
                    else {
                        c = d[0];
                        var n = d.find("source");
                        !c.src && n.length && (c.src = i.src, n.remove()), t.video.src && i.src != t.video.src ? (d.attr("autoplay", "autoplay"), c.src = i.src) : "none" != p.preload && h.dataload || (h.zeropreload ? t.trigger("ready", i).trigger("pause").one("ready", function() {
                            s.trigger("resume", [t])
                        }) : t.one("ready", function() {
                            s.trigger("pause", [t])
                        }))
                    }
                    o(c, e("source", d).add(d), i), "none" == p.preload && h.zeropreload && h.dataload || c.load(), p.splash && c.load()
                },
                pause: function() {
                    c.pause()
                },
                ...
                unload: function() {
                    e("video.fp-engine", s).remove(), h.cachedVideoTag || (m = null), l = clearInterval(l), c = 0
                }
            }
        };
        var w = /\.(\w{3,4})(\?.*)?$/i;
        e.throttle = function(e, t) {
            ...
            return this.each(function() {
                var s, n, a, o, r, l, c, d, h = e(this),
                    u = e(document),
                    p = h.children(":last"),
                    f = !1,
                    g = function() {
                        n = h.offset(), a = h.width(), o = h.height(), l = r ? o : a, d = y(c)
                    },
                    m = function(e) {
                        s || e == w.value || c && !(c > e) || (h.trigger("slide", [e]), w.value = e)
                    },
                    v = function(e) {
                        var i = e.pageX;
                ...
                g(), h.data("api", w).bind("mousedown.sld touchstart", function(t) {
                    if (t.preventDefault(), !s) {
                        var i = e.throttle(m, 100);
                        g(), w.dragging = !0, h.addClass("is-dragging"), m(v(t)), u.bind("mousemove.sld touchmove", function(e) {
                            e.preventDefault(), i(v(e))
                        }).one("mouseup touchend", function() {
                            w.dragging = !1, h.removeClass("is-dragging"), u.unbind("mousemove.sld touchmove")
                        })
                    }
                })
            })
            ...
            t.bind("ready", function() {
                ...
                !e.seekable && l.seekable && w.max(i), 1 > i ? h.css("width", 100 * i + "%") : h.css({
                    width: "100%"
                })
            }).bind("speed", function(e, t, i) {
                ...
                var e = t.video.time,
                    i = t.video.duration;
                w.dragging || w.slide(e / i, t.seeking ? 0 : 250), u.html(c(e)), p.html("-" + c(i - e))
            }).bind("finish resume seek", function(e) {
                i.toggleClass("is-finished", "finish" == e.type)
            }).bind("stop", function() {
                u.html(c(0)), w.slide(0, 100)
            }).bind("finish", function() {
                u.html(c(t.video.duration)), w.slide(1, 100), i.removeClass("is-seeking")
            ...
            var S = i.css("backgroundColor"),
                $ = "none" != i.css("backgroundImage") || S && "rgba(0, 0, 0, 0)" != S && "transparent" != S;
            !$ || r.splash || r.autoplay || t.bind("ready stop", function() {
                i.addClass("is-poster").one("progress", function() {
                    i.removeClass("is-poster")
                })
            }), !$ && t.forcedSplash && i.css("backgroundColor", "#555"), e(".fp-toggle, .fp-play", i).click(t.toggle), e.each(["mute", "fullscreen", "unload"], function(e, i) {
                s(i).click(function() {
                    t[i]()
                })
        ...
        e(document).bind(P ? "fullscreenchange" : C + "fullscreenchange", function(t) {
            ...
            i.length && !_ ? _ = i.trigger(S, [i]) : (_.trigger($, [_]), _ = null)
        }), flowplayer(function(t, i) {
            ...
            if (s().length) {
                ...
                t.bind("load", function(s, a, r) {
                    var l = n().removeClass(o),
                        c = l.attr("data-index"),
                        h = r.index = t.video.index || 0,
                        u = e('a[data-index="' + h + '"]', i).addClass(o),
                        p = h == t.conf.playlist.length - 1;
                    i.removeClass("video" + c).addClass("video" + h).toggleClass("last-video", p), r.index = a.video.index = h, r.is_last = a.video.is_last = p, d && (t.cuepoints = u.data("cuepoints"))
                            ...
                            for (var n, a, r, l, c = 0, d = i.split("\n"), h = d.length, u = {}; h > c; c++)
                                if (a = o.exec(d[c])) {
                                    ...
                                    u = {
                                        ...
                                        time: u.startTime,
                                        subtitle: u
                                    }, t.subtitles.push(u), t.cuepoints.push(l), t.cuepoints.push({
                                        time: u.endTime,
                                        subtitleEnd: n
                                    }), 0 === u.startTime && t.trigger("cuepoint", l)
                                }
                        }).fail(function() {
        ...
        var D = /IEMobile/.test(u);
        (flowplayer.support.touch || D) && flowplayer(function(t, i) {
            var s = /Android/.test(u) && !/Firefox/.test(u) && !/Opera/.test(u),
                n = /Silk/.test(u),
                a = s ? parseFloat(/Android\ (\d\.\d)/.exec(u)[1], 10) : 0;
            if (s && (t.conf.videoTypePreference = "mp4", !/Chrome/.test(u) && 4 > a)) {
                var o = t.load;
                t.load = function() {
        ...
        if ("file:" == location.protocol && (l = "localhost"), e.load.ed = 1, o.hostname = l, o.origin = r || location.href, r && t.addClass("is-embedded"), "string" == typeof c && (c = c.split(/,\s*/)), c && "function" == typeof n && n(c, l)) o.logo && t.append(a("<a>", {
            ...
            a(".fp-controls", t);
            var h = a('<div class="fp-context-menu"><ul><li class="copyright">&copy; 2013</li><li><a href="http://flowplayer.org">About Flowplayer</a></li><li><a href="http://flowplayer.org/license">GPL based license</a></li></ul></div>').appendTo(t);
            e.bind("pause resume finish unload", function(e, i) {
                ...
                }), i.load.ed = d.is(":visible") && a.contains(t[0], h[0]), i.load.ed || i.pause()) : d.hide()
            })
        }
    }), ! function() {
        var e = this,
        ...
        var _ = x.each = x.forEach = function(e, t, s) {
            if (null != e)
                if (h && e.forEach === h) e.forEach(t, s);
        ...
        x.map = x.collect = function(e, t, i) {
            var s = [];
            return null == e ? s : u && e.map === u ? e.map(t, i) : (_(e, function(e, n, a) {
        ...
        var S = x.some = x.any = function(e, t, s) {
            t || (t = x.identity);
            var n = !1;
        ...
        var z = function(e, t, i, s) {
            ...
            if ("[object Array]" == n) {
                ...
                for (var h in e)
                    if (x.has(e, h) && (l++, !(d = x.has(t, h) && z(e[h], t[h], i, s)))) break;
                if (d) {
                    for (h in t)
                        if (x.has(t, h) && !l--) break;
                    d = !l
                }
            }
        ...
        e.fn.bxSlider = function(n) {
            ...
            var r = e(window).width(),
                ...
                d = function() {
                    ...
                    "all" == a.settings.preloadImages && (t = a.children), a.settings.ticker ? a.settings.pager = !1 : (a.settings.pager && k(), a.settings.controls && x(), a.settings.auto && a.settings.autoControls && _(), (a.settings.controls || a.settings.autoControls || a.settings.pager) && a.viewport.after(a.controls.el)), h(t, u)
                },
                h = function(t, i) {
                ...
                p = function() {
                    ...
                    if ("vertical" == a.settings.mode || a.settings.adaptiveHeight)
                        if (a.carousel) {
                            ...
                            for (s = a.children.eq(n), i = 1; i <= a.settings.maxSlides - 1; i++) s = s.add(a.children.eq(n + i >= a.children.length ? i - 1 : n + i))
        ...
        var g = Math,
            ...
            _ = {
                ...
                initElement: function(e) {
                    if (!e.getContext) {
                        e.getContext = f, e.innerHTML = "", e.attachEvent("onpropertychange", u), e.attachEvent("onresize", h);
                        var t = e.attributes;
        ...
        _.init();
        for (var C = [], S = 0; 16 > S; S++)
            for (var $ = 0; 16 > $; $++) C[16 * S + $] = S.toString(16) + $.toString(16);
        var T = a.prototype;
        T.clearRect = function() {
            ...
            var o = a ? "at" : "wa",
                ...
                d = t + v(n) * i - k;
            r == c && !a && (r += .125);
            var h = this.getCoords_(e, t),
                u = this.getCoords_(r, l),
            ...
            var h = e.width,
                u = e.height;
            if (e.runtimeStyle.width = c, e.runtimeStyle.height = d, 3 == arguments.length) t = arguments[1], i = arguments[2], a = o = 0, r = s = h, l = n = u;
            else if (5 == arguments.length) t = arguments[1], i = arguments[2], s = arguments[3], n = arguments[4], a = o = 0, r = h, l = u;
            else {
            ...
            f.push(' ">', '<g_vml_:image src="', e.src, '"', ' style="width:', N * s, "px;", " height:", N * n, 'px;"', ' cropleft="', a / h, '"', ' croptop="', o / u, '"', ' cropright="', (h - a - r) / h, '"', ' cropbottom="', (u - o - l) / u, '"', " />", "</g_vml_:group>"), this.element_.insertAdjacentHTML("BeforeEnd", f.join(""))
        }, T.stroke = function(e) {
            var t = [],
            ...
            if (t.push(' ">'), e)
                if ("object" == typeof this.fillStyle) {
                    var h = this.fillStyle,
                        ...
                        v = 1;
                    if ("gradient" == h.type_) {
                        var b = h.x1_ / this.arcScaleX_,
                            y = h.y1_ / this.arcScaleY_,
                            w = this.getCoords_(h.x0_ / this.arcScaleX_, h.y0_ / this.arcScaleY_),
                            k = this.getCoords_(b, y);
                        u = 180 * Math.atan2(k.x - w.x, k.y - w.y) / Math.PI, 0 > u && (u += 360), 1e-6 > u && (u = 0)
                    } else {
                        var w = this.getCoords_(h.x0_, h.y0_),
                            x = l.x - a.x,
                            _ = l.y - a.y;
                        p = {
                            x: (w.x - a.x) / x,
                        ...
                        var C = g.max(x, _);
                        f = 2 * h.r0_ / C, v = 2 * h.r1_ / C - f
                    }
                    var S = h.colors_;
                    S.sort(function(e, t) {
                        return e.offset - t.offset
                    });
                    for (var $ = S.length, T = S[0].color, P = S[$ - 1].color, j = S[0].alpha * this.globalAlpha, z = S[$ - 1].alpha * this.globalAlpha, A = [], c = 0; $ > c; c++) {
                        var D = S[c];
                        A.push(D.offset * v + f + " " + D.color)
                    }
                    t.push('<g_vml_:fill type="', h.type_, '"', ' method="none" focus="100%"', ' color="', T, '"', ' color2="', P, '"', ' colors="', A.join(","), '"', ' opacity="', z, '"', ' g_o_:opacity2="', j, '"', ' angle="', u, '"', ' focusposition="', p.x, ",", p.y, '" />')
    ...
    function(e) {
        ...
        var o = /\+/g,
            r = e.cookie = function(n, o, l) {
                ...
                for (var h = n ? void 0 : {}, u = document.cookie ? document.cookie.split("; ") : [], p = 0, f = u.length; f > p; p++) {
                    var g = u[p].split("="),
                        m = i(g.shift()),
                        v = g.join("=");
                    if (n && n === m) {
...
Tipped.Skins = {
    ...
    function(e) {
        ...
        function i(t, i) {
            function S(t) {
                if (!(rt() || e(t.target).closest(i.excludedElements, Lt).length > 0)) {
                    var s, n = t.originalEvent ? t.originalEvent : t,
                        a = _ ? n.touches[0] : n;
                    return Bt = w, _ ? Qt = n.touches.length : t.preventDefault(), Dt = 0, It = null, Ht = null, Rt = 0, Mt = 0, Et = 0, Wt = 1, Ot = 0, Ft = ut(), qt = gt(), at(), !_ || Qt === i.fingers || i.fingers === b || q() ? (ct(0, a), Ut = _t(), 2 == Qt && (ct(1, n.touches[1]), Mt = Et = bt(Ft[0].start, Ft[1].start)), (i.swipeStatus || i.pinchStatus) && (s = D(n, Bt))) : s = !1, s === !1 ? (Bt = x, D(n, Bt), s) : (lt(!0), null)
                }
            }
            ...
            function z() {
                Lt.unbind(Tt, S), Lt.unbind(At, P), Lt.unbind(Pt, $), Lt.unbind(jt, T), zt && Lt.unbind(zt, j), lt(!1)
            }
            ...
            function D(e, t) {
                var i = void 0;
                return F() || Q() ? i = I(e, t, h) : (L() || q()) && i !== !1 && (i = I(e, t, u)), it() && i !== !1 ? i = I(e, t, f) : st() && i !== !1 ? i = I(e, t, g) : tt() && i !== !1 && (i = I(e, t, p)), t === x && P(e), t === k && (_ ? 0 == e.touches.length && P(e) : P(e)), i
            }
            ...
            function lt(e) {
                e === !0 ? (Lt.bind(Pt, $), Lt.bind(jt, T), zt && Lt.bind(zt, j)) : (Lt.unbind(Pt, $, !1), Lt.unbind(jt, T, !1), zt && Lt.unbind(zt, j, !1)), Lt.data(C + "_intouch", e === !0)
            }
            ...
            var $t = _ || !i.fallbackToMouseEvents,
                Tt = $t ? "touchstart" : "mousedown",
                Pt = $t ? "touchmove" : "mousemove",
                jt = $t ? "touchend" : "mouseup",
                zt = $t ? null : "mouseleave",
                At = "touchcancel",
                Dt = 0,
                It = null,
                Rt = 0,
                ...
                Gt = null;
            try {
                Lt.bind(Tt, S), Lt.bind(At, P)
            } catch (Kt) {
                e.error("events not supported " + Tt + "," + At + " on jQuery.swipe")
            }
            this.enable = function() {
                return Lt.bind(Tt, S), Lt.bind(At, P), Lt
    ...
    function(e, t, i, s) {
        ...
        if ($(".peerius-rec"), e[0].recs.length > 0) {
...
var teradata = function() {
    ...
    mainModule = function() {
        ...
        if ($(window).resize(function() {
                ...
                var h = 0;
                $("header .nav-bar").length > 0 && "undefined" != typeof $("header .nav-bar").offset && (h = $("header .nav-bar").offset().top), $(".category-container .category-nav-list").removeClass("hide-on-tablet"), $(".landingPage a").click(function() {
                    try {
            ...
            var x = _.debounce(u, 300);
            _.defer(u), $(window).resize(x), $(".range-product").click(function() {
                var e = $(this);
        ...
        return $(".editorial-buy-off").length > 0 && $(".range-product").click(function() {
            $(this), 0 == $(".scrollToBuyOff").length ? setTimeout(function() {
                $("body, html").animate({
    ...
    rangeModule = function() {
        ...
        var y = function() {
                        ...
                        if ("title" != prop && "description" != prop && "details" != prop && "fitNotes" != prop && "provenance" != prop && "restricted" !== prop) {
                            ...
                            if (0 == $(".selected-colour-tile").length) {
                                ...
                                if (i.length > 0) {
                                    ...
                                    if ($("#lookbook-outer-wrap, #jersey-outer-wrap").length > 0)
                                        for (var d = !1, a = 0; a < lookbookModule.lookbookFoundItem.products.length; a++) {
                                            for (var h = 0; h < i.length; h++)
                                                if (-1 != i[h].prodId.indexOf(lookbookModule.lookbookFoundItem.products[a].prodId.slice(0, 5)) && -1 != i[h].upImg.toLowerCase().indexOf("/" + lookbookModule.lookbookFoundItem.products[a].skuColor.toLowerCase() + "/")) {
                                                    l = i[h], d = !0;
                                                    break
                                                }
                                            if (d) break
                                    ...
                                    var u = "";
                                    u = l.upImg.replace(sizeRegex, "/250/"), c ? $($("#" + l.prodId + " img")[0]).attr({
                                        src: u.replace("gift_clear", "gift/clear"),
            ...
            k = function() {
                ...
                if (!d && currentIndividualObj) {
                    ...
                    for (var i = 0; i < productJson.products.length; i++) {
                        var h = productJson.products[i];
                        if (h.title == n) {
                            var t = "";
                            for (prop in h)
                                if ("title" != prop && "description" != prop && "details" != prop && "fitNotes" != prop && "provenance" != prop)
                                    for (var u = h[prop], r = !1, p = 0; p < u.length; p++) {
                                        var a = "",
                                            o = "";
                                        if ($(".selected-swatch").attr("base-colour").toLowerCase() == u[p].baseColour.toLowerCase() && $(".selected-swatch").attr("title").toLowerCase() == u[p].colour.toLowerCase() || $(".selected-swatch").attr("alt").toLowerCase() == u[p].colour.toLowerCase()) {
                                            t && 0 != t.length || (t = "Undetermined");
                                            for (var l = 0; l < stockJson.stocklist.length; l++)
                                                if (stockJson.stocklist[l].prodId.toLowerCase() == u[p].prodId.toLowerCase()) {
                                                    for (var c = 0; c < stockJson.stocklist[l].sizesInStock.length; c++)
                                                        if (u[p].skuSetArr[0].toLowerCase() == stockJson.stocklist[l].sizesInStock[c].sku.toLowerCase()) {
                                                            ("0" != stockJson.stocklist[l].sizesInStock[c].stlev || "" != stockJson.stocklist[l].sizesInStock[c].preOrderAvailable) && (r = !0, o = stockJson.stocklist[l].sizesInStock[c].stlev), t = stockJson.stocklist[l].sizesInStock[c].value1, a = stockJson.stocklist[l].sizesInStock[c].preOrderAvailable;
                                                            break
                                                        }
                                                    break
                                                }
                                            if ("Undetermined" == t && void 0 != h.fitNotes) {
                                                var f = h.fitNotes,
                                                    g = f.indexOf("&quot;&gt;"),
                                                    m = f.indexOf("&lt;", g);
                                                t = f.slice(g + 10, m)
                                            }
                                            e.append($(r ? '<li class="grid-10 tablet-grid-10 mobile-grid-10 size" prod-id="' + prop + '" sku-id="' + u[p].skuSetArr[0] + '" data-oos="' + !r + '" pre-order="' + a + '" low-stock="' + o + '" data-price="' + u[p].price + '">' + t + "</li>" : '<li class="grid-10 tablet-grid-10 mobile-grid-10 size size-out-of-stock out-of-stock" prod-id="' + prop + '" sku-id="' + u[p].skuSetArr[0] + '" data-oos="' + !r + '" pre-order="" low-stock="" data-price="' + u[p].price + '">' + t + "</li>"))
                                        }
                                    }
                        }
                    }
            ...
            C = function() {
            	...
            	if (!$('.group-buy-off .hiddenSwatches').length){
        				$(".group-buy-off").prepend("<div class='hiddenSwatches'></div>")
    			}
                ...
                for (var t = 0; t < i.length; t++) {
                    ...
                    if ($(".group-buy-off .product-swatches").append(p), !d && e.length > 0 && e.attr("prod-code").toLowerCase() === c.prodId.toLowerCase()) p.find("img").addClass("selected-swatch"), currentIndividualObj = c, $(".colour-showing").text(c.colour);
                        ...
                        for (var f = 0; f < i.length; f++) u == i[f].baseColour.toLowerCase() && (p.find("img").addClass("selected-swatch"), currentIndividualObj = i[f], $(".colour-showing").text(c.colour), u = i[f].baseColour.toLowerCase())
                }
            ...
            z = function(e) {
                ...
                if ("undefined" != typeof currentIndividualObj && (g = window.innerWidth, "undefined" == typeof f && (f = window.innerWidth), !(f > g && t === !1))) {
                    ...
                    $('.product-swatches img').each(function () {
						thisURL = $(this).attr('src').split( '/' );
						newURL = 'https://d117fiyhpld8f9.cloudfront.net/global/'+thisURL[4]+'/'+thisURL[5]+'_sw/250/'+thisURL[7]+'.jpg'
						$(this).attr("src", newURL);
						swatched = true;
					});
        ...
        return addRangeListeners = function() {
            $(".group-images").on("click", ".range-product", function() {
                ...
                $(this).hasClass("selected-colour-tile") || ($(".selected-colour-tile").length > 0 && $(".selected-colour-tile").removeClass("selected-colour-tile"), $(".selected-mix-tile").length > 0 && $(".selected-mix-tile").removeClass("selected-mix-tile"), $(this).addClass("selected-colour-tile"), u = $(this).attr("base-colour"), y(), setCurrentObj(!1), w(), isLookBook && (C(), k()), P())
            ...
            if ("undefined" == typeof isLookBook && (isLookBook = !1), isLookBook && $(".template-buy-off").after(I()), $(".lightbox-template-buy-off").after(D()), "" != $("#range-lifestyle-holder").data("src") && "undefined" != $("#range-lifestyle-holder").data("src") && $(".range-lifestyle").attr("src", $("#range-lifestyle-holder").data("src")), $(".buy-off-container").length > 0 && (R(), addRangeListeners(), $("#breadcrumb").removeClass("grid-90 tablet-grid-90 suffix-5 prefix-5 tablet-suffix-5 tablet-prefix-5 grid-80 tablet-grid-80 tablet-prefix-10 tablet-suffix-10 suffix-10 prefix-10").addClass("grid-100 tablet-grid-100 grid-parent"), $(".range-breadcrumb").removeClass("grid-60 prefix-5").addClass("grid-100"), $(".breadcrumb-browse-controls").removeClass("grid-95 tablet-grid-95 mobile-grid-95 tablet-prefix-5 tablet-suffix-5 mobile-prefix-5 mobile-suffix-5").addClass("grid-100 tablet-grid-100 mobile-grid-100"), $(".template-buy-off, .buy-off-container").removeClass("grid-90 prefix-5 suffix-5").addClass("grid-100")), 0 == $(".lookbook-buy-off, .jersey-buy-off").length) {
                p = null, h = !1, $(window).width() < 767 && (h = !0, p = $(".group-images .group-images-set-one").bxSlider({
                    touchEnabled: !1,
                    auto: !1,
                    slideWidth: 500,
                    minSlides: 3,
                ...
                $(window).resize(function() {
                    e(function() {
                        $(window).width() < 767 && !h ? (h = !0, p = $(".group-images .group-images-set-one").bxSlider({
                            touchEnabled: !1,
                            auto: !1,
                            slideWidth: 500,
                            minSlides: 3,
                            maxSlides: 3
                        })) : p && p.destroySlider && $(window).width() > 768 && (p.destroySlider(), p = null, h = !1)
                    }, 500, "windowResize")
                })
            }
        }), e = {
        ...
        var e = {
            ...
            c = function() {
                $.ajax({
                    ...
                    dataType: "json",
                    success: function(t) {
                        e.wishlistStockJson = $.parseJSON(t.d), h(), p(), r()
                    }
                })
            },
            d = function(t) {
            ...
            p = function() {
                ...
                l(window.location.origin + "/content/wishlist/view-wishlist.htm?sharedWish=" + t + "&wishTitle=Toast Wishlist"), $(".wishlist-add-all").click(function(e) {
                    ...
                    u(t), $(".expanding-wish-sharer").addClass("wish-sharer-closed")
            ...
            g = function(t, a, o, r) {
                ...
                var u = "";
                a.price != a.salePrice && (h = parseFloat(a.salePrice).toFixed(2).replace(".00", ""), u = '<span class="sale-price">' + l + h + "</span>");
                var p = "",
                    f = n,
                ...
                return $(['<div class="wishlist-product grid-25 tablet-grid-33 mobile-grid-100" sku="' + r.skuCode + '" prod-key="' + a.prodId + '">', '<div class="wishlist-image grid-100 tablet-grid-100 mobile-grid-100">', '<a href="/product/' + a.parentCategory.replace(/ /g, "+").replace(/\//g, "+") + "/" + o + "/" + t.title.replace(/ /g, "+").replace(/\//g, "+") + ".htm?clr=" + a.prodId.slice(0, 5) + "_" + a.colour.replace(/ /g, "").replace(/\//g, "") + '">', '<img src="' + a.upImg.replace("/product/", "/global/") + '" alt="' + t.title + '" title="' + t.title + '" class="grid-image product-image">', "</a>", "</div>", '<div class="wishlist-details-wrapper grid-100 tablet-grid-100 mobile-grid-100">', '<div class="wishlist-details grid-100 tablet-grid-100 mobile-grid-100 grid-parent">', '<h3 class="wish-item-title">' + t.title + "</h3>", '<p class="price-of-item" price="' + h + '">' + c + " " + u + "</p>", '<h3 class="wishlist-item-colour">' + a.colour + "</h3>", '<h3 class="wishlist-item-size">Size: ' + m + "</h3>", p, '<h3 class="wish-item-qty"></h3>', "</div>", '<div class="grid-100 tablet-grid-100 mobile-grid-100 grid-parent">', '<div class="wishlist-add-to-bag-btn"><span>' + f + "</span></div>", "</div>", '<div class="wishlist-button-container">', '<span class="wishlist-edit-btn">Edit</span><span class="slash-seperator">/</span><span class="wishlist-delete-btn">Remove</span>', "</div>", '<span class="range-product visuallyHidden" id="' + r.prodCode + '"><img></span>', "</div>", "</div>"].join(""))
            },
            m = function() {
                    ...
                    success: function(e) {
                        if (!e.HasErrors)
                            if (0 === e.TotalResults) $(".noReviews").removeClass("visuallyHidden"), $("#review-section header h2").text("Reviews (0)"), $("#reviewContainer").addClass("visuallyHidden"), $(".noReviews").length < 1 && ($("#reviewContainer").before('<p class="noReviews">There are currently no reviews for this product.</p>'), tcp_env.user.email.length > 0 ? ($("#reviewContainer").before('<p class="noReviews"><a href="http://display.ugc.bazaarvoice.com/static/toast/en_GB/container.htm?bvaction=rr_submit_review&bvproductId=' + r + '" target="_blank">Be the first to review this product.</a></p>'), $("#review-section header h2").after($('<a href="http://display.ugc.bazaarvoice.com/static/toast/en_GB/container.htm?bvaction=rr_submit_review&bvproductId=' + r + '" target="_blank"><span class="first-to-review-summary noReviews">be first to review this</span></a>'))) : ($("#reviewContainer").before('<p class="noReviews"><a href="' + l + '">Be the first to review this product.</a></p>'), $("#review-section header h2").after($('<a href="' + l + '"><span class="first-to-review-summary noReviews">Be first to review this</span></a>')))), $("#reviewContainer").removeClass("visuallyHidden").addClass("no-reviews"), tcp_env.user.email.length > 0 ? ($(".noReviews a, #add-review").attr("href", "http://display.ugc.bazaarvoice.com/static/toast/en_GB/container.htm?bvaction=rr_submit_review&bvproductId=" + r), $(".first-to-review-summary").parent().attr("href", "http://display.ugc.bazaarvoice.com/static/toast/en_GB/container.htm?bvaction=rr_submit_review&bvproductId=" + r)) : $("#reviewContainer .review-dropdown").hide(), $("#reviewSummaryContainer").hide();
                                ...
                                for (var d = 0, h = 0; h < e.Results.length; h++) d += e.Results[h].Rating, e.Results[h].Rating > t && (t = e.Results[h].Rating);
                                var u = 0 == e.TotalResults ? 1 : e.TotalResults,
                                    p = (d / u).toFixed(1),
                                    f = Math.ceil(p / 5 * 100);
                                ...
                                for (var h = 0; h < e.Results.length; h++) {
                                    $newReview = n(e.Results[h]), i > h ? $("#reviewContainer ul.review-list").append($newReview) : $(".product-reviews-bottom").append($newReview);
