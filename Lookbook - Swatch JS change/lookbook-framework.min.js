var lookbookModule = function() {
    ...
    $(document).ready(function() {
        ...
        if ($("#imgNames").length > 0) {
            ...
            $("#imgNames").on("click", ".catImagesJQLink", function(e) {
                if (Modernizr.mq("(max-width: 767px)")) {
                    e.preventDefault();
                    if (typeof $(this).attr("data-id") !== "undefined" && $(this).attr("data-id") !== false) {
                        currentLookBookID = $(this).data("id");
                        setSources(false, true);
                        getLookbookProductInfo(getDataStr());
                        $(this).parent().after($(".jersey-buy-off, .buy-off-container"));
                        $(".template-buy-off").prepend($("#social"));
                        $("#social img").attr({
                            width: "40",
                            height: "40"
                        });
                        ...
                        rangeModule.toggleOpenDescription();
                        _gaq.push(["_trackEvent", "Lookbook Shop Button", "Click", $("#jersey-outer-wrap").attr("collection") + " image " + $(this).attr("data-id")])
                    }
                } else {
                    _gaq.push(["_trackEvent", "Lookbook (New) Tile", "Click", $("#jersey-outer-wrap").attr("collection") + " image " + $(this).attr("data-id")])
                }
            })
        }
        if ($(".jersey-buy-off").length > 0) {
